...
```{r reninangiotensin, fig.cap='(ref:renin)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/endocrine/Renin-angiotensin_system_in_man_shadow.svg")
```
