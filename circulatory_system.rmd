...
```{r systemiccirculation, fig.cap='(ref:syscirc)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/circulation/2101_Blood_Flow_Through_the_Heart.jpg")
```
...
```{r pulmonarycirculation, fig.cap='(ref:pulcirc)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/circulation/2119_Pulmonary_Circuit.jpg")
```
...
```{r heartdiagram, fig.cap='(ref:heart)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/circulation/Diagram_of_the_human_heart_(cropped).svg")
```
...
```{r coronaryvessels, fig.cap='(ref:coronary)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/circulation/Coronary_arteries.svg")
```
...
```{r conductionsystem, fig.cap='(ref:consys)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/circulation/ConductionsystemoftheheartwithouttheHeart-en.svg")
```
...
```{r cardiacekg, fig.cap='(ref:cardcy)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/circulation/2027_Phases_of_the_Cardiac_Cycle.jpg")
```
...
```{r atherosclerosis, fig.cap='(ref:athero)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/circulation/2113ab_Atherosclerosis.jpg")
```
