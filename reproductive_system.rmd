...
```{r femalereproductivesystem, fig.cap='(ref:femalerepsys)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/reproductive_system/Scheme_female_reproductive_system-en.svg")
```
...
```{r vulvaview, fig.cap='(ref:vulva)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/reproductive_system/Figure_28_02_02.jpg")
```
...
```{r menstrualcycle, fig.cap='(ref:menscyc)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/reproductive_system/Figure_28_02_07.jpg")
```
...
```{r malereproductivesystem, fig.cap='(ref:malerepsys)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/reproductive_system/male anatomy.svg")
```
...
```{r testesdiagram, fig.cap='(ref:testes)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/reproductive_system/Figure_28_01_03.jpg")
```
...
```{r differentiationrepsys, fig.cap='(ref:sexdif)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/reproductive_system/2915_Sexual_Differentation-02.jpg")
```
...
```{r testesbiopsy, fig.cap='(ref:testbio)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/reproductive_system/Normal_spermatogenesis,_intermed._mag.jpg")
```
...
```{r spermatogenesis, fig.cap='(ref:spermgen)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/reproductive_system/Figure_28_01_04.jpg")
```
...
```{r ovariancortex, fig.cap='(ref:ovcor)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/reproductive_system/Ovarian_cortex_in_a_rhesus_monkey.jpg")
```
...
```{r oogenesis, fig.cap='(ref:oogen)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/reproductive_system/Oogenesis_Labeled.svg")
```
