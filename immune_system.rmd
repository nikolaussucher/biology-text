...
```{r lymphaticsystem, fig.cap='(ref:lymph)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/immune/Blausen_0623_LymphaticSystem_Female.png")
```
...
```{r humanthymus, fig.cap='(ref:thymus)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/immune/Illu_thymus.jpg")
```
...
```{r humanspleen, fig.cap='(ref:spleen)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/immune/Illu_spleen.jpg")
```
...
```{r lymphnode, fig.cap='(ref:lymphnod)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/immune/Schematic_of_lymph_node_showing_lymph_sinuses.svg")
```
...
```{r lymphaticcapillaries, fig.cap='(ref:lymphcap)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/immune/2202_Lymphatic_Capillaries_big.png")
```
...
```{r lymphnutrient, fig.cap='(ref:lymphnut)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/immune/Nutrient_absorbtion_to_blood_and_lymph.png")
```
...
```{r immunesystem, out.width='75%', echo=FALSE, message=FALSE, warning=FALSE}
library(tidyverse)
library(printr)        
library(kableExtra)
setwd("~/Dropbox/R/biology-text-master")

immune <-  as_tibble(read.csv("data/immune_system.csv"))

knitr::kable(immune, col.names = c("Innate immune system", "Adaptive immune system"), digits = 2, align = 'll', booktabs = TRUE, caption = "Comparison of major characteristics of the innate and adaptive immune systems.") %>% kable_styling(latex_options = c("striped", "hold_position"))
```
...
```{r bloodcellsem, fig.cap='(ref:bloodcells)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/immune/SEM_blood_cells.jpg")
```
...
```{r neutrophago, fig.cap='(ref:phago)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/immune/Neutrophil_with_anthrax_copy.jpg")
```
...
```{r phagocytosisdiagram, fig.cap='(ref:phagdia)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/immune/Phagocytosis2.png")
```
...
```{r neutrophil, fig.cap='(ref:neutro)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/immune/PBNeutrophil.jpg")
```
...
```{r eosinophil, fig.cap='(ref:eosin)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/immune/Eosinophil_blood_smear.jpg")
```
...
```{r complementsystem, fig.cap='(ref:complement)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/immune/Complement_pathway.svg")
```
...
```{r immuneoverview, fig.cap='(ref:imov)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/immune/Primary_immune_response_1.png")
```
...
knitr::include_graphics("./figures/immune/Antigen_presentation.svg")
```
...
```{r tcellactivation, fig.cap='(ref:tactiv)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/immune/T_cell_activation.svg")
```
...
```{r bcellactivation, fig.cap='(ref:bactiv)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/immune/B_cell_activation.svg")
```
...
```{r antibodystructure, fig.cap='(ref:antibstruc)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/immune/Antibody_chains.svg")
```
