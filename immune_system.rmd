...
knitr::kable(immune, col.names = c("Innate immune system", "Adaptive immune system"), digits = 2, align = 'll', booktabs = TRUE) %>% kable_styling(latex_options = c("striped", "hold_position"))
```
