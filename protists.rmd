...
knitr::kable(protmet, col.names = c("Nutritional Type", "Source of Energy", "Source of Carbon", "Examples"), digits = 2, align = 'llll', booktabs = TRUE) %>% kable_styling(latex_options = c("striped", "hold_position"))
```
