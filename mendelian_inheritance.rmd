...
```{r laws, out.width='75%', echo=FALSE, message=FALSE, warning=FALSE}
library(tidyverse)
library(printr)        
library(kableExtra)
setwd("~/Dropbox/R/biology-text-master")

mendellaws <-  as_tibble(read.csv("data/laws.csv"))

knitr::kable(mendellaws, col.names = c("Law", "Definition"), digits = 2, align = 'll', booktabs = TRUE, caption = "Mendel's Laws of Inheritance.") %>% kable_styling(latex_options = c("striped", "hold_position"))
```
