...
\caption{(ref:majendo)}(\#fig:majorendocrineglands)
\end{figure}
...
\caption{(ref:exhorm)}(\#fig:hormoneexamples)
\end{figure}
...
\caption{(ref:hormact)}(\#fig:hormoneaction)
\end{figure}
...
\caption{(\#tab:anteriorpituitaryhormones)Hormones of the anterior pituitary gland.}
\centering
...
\caption{(\#tab:posteriorpituitaryhormones)Hormones of the posterior pituitary gland.}
\centering
\begin{tabular}[t]{llll}
\toprule
Secreted hormone & Abbreviation & Produced by & Effect\\
