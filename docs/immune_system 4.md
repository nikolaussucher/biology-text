...
<div style="border: 1px solid #ddd; padding: 0px; overflow-y: scroll; height:100; overflow-x: scroll; width:100%; "><table class="table" style="margin-left: auto; margin-right: auto;">
 <thead>
  <tr>
   <th style="text-align:left;position: sticky; top:0; background-color: #FFFFFF;"> Innate immune system </th>
   <th style="text-align:left;position: sticky; top:0; background-color: #FFFFFF;"> Adaptive immune system </th>
  </tr>
 </thead>
<tbody>
  <tr>
   <td style="text-align:left;"> Innate immune system </td>
   <td style="text-align:left;"> Adaptive immune system </td>
  </tr>
  <tr>
