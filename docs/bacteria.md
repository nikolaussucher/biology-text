...
<div style="border: 1px solid #ddd; padding: 0px; overflow-y: scroll; height:100; overflow-x: scroll; width:100%; "><table class="table" style="margin-left: auto; margin-right: auto;">
 <thead>
  <tr>
   <th style="text-align:left;position: sticky; top:0; background-color: #FFFFFF;"> Property </th>
   <th style="text-align:left;position: sticky; top:0; background-color: #FFFFFF;"> Bacteria </th>
   <th style="text-align:left;position: sticky; top:0; background-color: #FFFFFF;"> Archaea </th>
   <th style="text-align:left;position: sticky; top:0; background-color: #FFFFFF;"> Eukarya </th>
  </tr>
 </thead>
<tbody>
  <tr>
