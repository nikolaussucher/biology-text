...
knitr::kable(plantae, col.names = c("Name", "Scope", "Distribution"), digits = 2, align = 'lll', booktabs = TRUE, caption = "Four commonly used concepts of plants.") %>% kable_styling(latex_options = c("striped", "hold_position")) %>% column_spec(1, width = "20em") %>% column_spec(2, width = "10em") %>% column_spec(3, width = "20em")
```
...
knitr::kable(angi, col.names = c("Feature", "Description"), digits = 2, align = 'll', booktabs = TRUE) %>% kable_styling(latex_options = c("striped", "hold_position"))
```
