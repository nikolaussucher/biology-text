...
```{r plantdiversity, fig.cap='(ref:plantdiv)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/plants/Diversity_of_plants_image_version_5.png")
```
...
```{r plants, out.width='75%', echo=FALSE, message=FALSE, warning=FALSE}
library(tidyverse)
library(printr)        
library(kableExtra)
setwd("~/Dropbox/R/biology-text-master")

plantae <-  as_tibble(read.csv("data/plants.csv"))

knitr::kable(plantae, col.names = c("Name", "Scope", "Distribution"), digits = 2, align = 'lll', booktabs = TRUE, caption = "Four commonly used concepts of plants.") %>% kable_styling(bootstrap_options = c("striped", "condensed", "responsive"))
```
...
```{r cooksonia, fig.cap='(ref:cooks)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/plants/Cooksonia_pertoni.png")
```
...
```{r marchantia, fig.cap='(ref:march)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/plants/Marchantia.jpg")
```
...
```{r hornwort, fig.cap='(ref:horn)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/plants/Hornwort_(3144429129).jpg")
```

(ref:moss) A moss showing both gametophytes (the low, leaf-like forms) and sporophytes (the tall, stalk-like forms). 

```{r sporophytemoss, fig.cap='(ref:moss)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/plants/IMG_1227.jpg")
```
...
```{r seedcollection, fig.cap='(ref:seedcol)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/plants/seeds_diversity.jpg")
```
...
```{r varioousgymnosperms, fig.cap='(ref:gymno)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/plants/Gymnospermae.jpg")
```
...
```{r floweringplants, fig.cap='(ref:flowering)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/plants/Flower_poster_2.jpg")
```
...
```{r angiospermfeatures, out.width='75%', echo=FALSE, message=FALSE, warning=FALSE}
library(tidyverse)
library(printr)        
library(kableExtra)
setwd("~/Dropbox/R/biology-text-master")

angi <-  as_tibble(read.csv("data/angiosperms.csv"))

knitr::kable(angi, col.names = c("Feature", "Description"), digits = 2, align = 'll', booktabs = TRUE, caption = "Distinctive features of angiosperms.") %>% kable_styling(latex_options = c("striped", "hold_position"))
```
...
knitr::include_graphics("./figures/plants/mature_flower.svg")
```
...
```{r lilistamen, fig.cap='(ref:lili)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/plants/Lillium_Stamens.jpg")
```
...
```{r beeorchid, fig.cap='(ref:orchid)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/plants/Ophrys_apifera_flower1.jpg")
```
...
```{r miscpollen, fig.cap='(ref:pollen)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/plants/Misc_pollen_colorized.jpg")
```
...
```{r flowersfruits, fig.cap='(ref:flowfrui)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/plants/Spathoglottis_flwrs_reduced.jpg")
```
...
```{r gynoecium, fig.cap='(ref:gyno)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/plants/Magnolia_wieseneri_-_labelled_gynoecium.jpg")
```
...
```{r ovarycross, fig.cap='(ref:ovule)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/plants/Narcis_zaadhokken.jpg")
```
...
```{r fruitdevelopment, fig.cap='(ref:fruitdev)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/plants/Nectarine_Fruit_Development.jpg")
```
