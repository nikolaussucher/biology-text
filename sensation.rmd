...
knitr::include_graphics("./figures/sensation/anatomyofhumanbo1918gray_1008.jpg")
```
...
knitr::include_graphics("./figures/sensation/retina_cajal.png")
```
...
knitr::include_graphics("./figures/sensation/FrogRetinaCajalManual.jpg")
```
...
knitr::include_graphics("./figures/sensation/PhotorecptorsCajalManual.jpg")
```
...
knitr::include_graphics("./figures/sensation/Visual_cycle.svg")
```
...
knitr::include_graphics("./figures/sensation/Phototransduction.png")
```
...
knitr::include_graphics("./figures/sensation/Human_visual_pathway.svg")
```
...
knitr::include_graphics("./figures/sensation/Visual_field_maps.jpg")
```
...
```{r rightear, fig.cap='(ref:ear)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/sensation/GrayEar.jpg")
```
...
```{r organcorti, fig.cap='(ref:corti)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/sensation/Cochlea-crosssection.svg")
```
...
```{r skindiagram, fig.cap='(ref:skin)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/sensation/Gray940.png")
```
...
```{r mechanosensitive, fig.cap='(ref:mechano)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/sensation/mechano_sensitive_channel.png")
```
...
```{r tactilecorpuscle, fig.cap='(ref:corp)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/sensation/TouchReceptors.jpg")
```
...
```{r TRPV1channel, fig.cap='(ref:TRPV1)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/sensation/TRPV1.png")
```
...
```{r musclespindle, fig.cap='(ref:spindle)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/sensation/CajalMuscleSpindle.jpg")
```
...
```{r tendonorgan, fig.cap='(ref:tendon)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/sensation/CajalGolgiTendon.jpg")
```
...
knitr::include_graphics("./figures/sensation/GrayP572.jpg")
```
...
knitr::include_graphics("./figures/sensation/CajalOlfactoryPathway.jpg")
```
...
knitr::include_graphics("./figures/sensation/tongue.jpg")
```
...
```{r vallatepapilla, fig.cap='(ref:papilla)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/sensation/CunninghamSection2Page770.jpg")
```
...
```{r tastebuds, fig.cap='(ref:buds)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/sensation/CunninghamSection2Page771.jpg")
```
...
```{r tastecells, fig.cap='(ref:cells)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/sensation/CunninghamSection2Page771Cells.jpg")
```
