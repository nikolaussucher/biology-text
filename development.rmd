...
```{r generaldevelopmentscheme, fig.cap='(ref:gendev)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/development/Slack_Essential_Dev_Biol_Fig_02-08.jpg")
```
...
```{r cellulardifferentiation, fig.cap='(ref:celldif)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/development/Final_stem_cell_differentiation_(1).svg")
```
...
```{r hoxgenes, fig.cap='(ref:hoxg)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/development/Genes_hox.jpg")
```
...
```{r pregnancystages, fig.cap='(ref:pregstag)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/development/Prenatal_development_table.svg")
```
...
```{r blastocyst, fig.cap='(ref:blastoc)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/development/Blastocyst_English.svg")
```
...
```{r humanembryonicdevelopment, fig.cap='(ref:embdev)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/development/HumanEmbryogenesis.svg")
```
...
```{r eightcellembryo, fig.cap='(ref:eighcell)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/development/Embryo,_8_cells.jpg")
```
...
```{r germlayers, fig.cap='(ref:germlay)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/development/Germ_layers.jpg")
```
...
```{r embryoandplacenta, fig.cap='(ref:placen)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/development/2910_The_Placenta-02.jpg")
```
...
```{r heartdevelopment, fig.cap='(ref:heartdev)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/development/2037_Embryonic_Development_of_Heart.jpg")
```
...
```{r humanembryo, fig.cap='(ref:brainembryo)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/development/Human_embryo_8_weeks_4.jpg")
```
