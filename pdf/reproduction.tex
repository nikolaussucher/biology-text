...
\chapter{Sexual Reproduction And Meiosis}\label{sexual-reproduction-and-meiosis}}
...
\caption{\href{https://commons.wikimedia.org/wiki/File:Sperm-egg.jpg}{Sperm fertilizing an egg.}}\label{fig:spermfertilizingegg}
\end{figure}
...
\caption{\href{https://commons.wikimedia.org/wiki/File:Meiosis_Overview_new.svg}{In meiosis}, the chromosome or chromosomes duplicate (during interphase) and homologous chromosomes exchange genetic information (chromosomal crossover) during the first division, called meiosis I. The daughter cells divide again in meiosis II, splitting up sister chromatids to form haploid gametes. Two gametes fuse during fertilization, creating a diploid cell with a complete set of paired chromosomes.}\label{fig:meiosisoverview}
\end{figure}
...
Meiosis was discovered and described for the first time in sea urchin eggs in 1876 by the German biologist \href{https://en.wikipedia.org/wiki/Oscar_Hertwig}{Oscar Hertwig}. It was described again in 1883, at the level of chromosomes, by the Belgian zoologist \href{https://en.wikipedia.org/wiki/Edouard_Van_Beneden}{Edouard Van Beneden}, in Ascaris roundworm eggs. The significance of meiosis for reproduction and inheritance, however, was described only in 1890 by German biologist \href{https://en.wikipedia.org/wiki/August_Weismann}{August Weismann}, who noted that two cell divisions were necessary to transform one diploid cell into four haploid cells if the number of chromosomes had to be maintained. In 1911 the American geneticist \href{https://en.wikipedia.org/wiki/Thomas_Hunt_Morgan}{Thomas Hunt Morgan} detected crossovers in meiosis in the fruit fly \emph{Drosophila melanogaster}, which helped to establish that genetic traits are transmitted on chromosomes.

The term ``meiosis'' (originally spelled ``maiosis'') is derived from the Greek word μείωσις, meaning `lessening'. It was introduced to biology by \href{https://en.wikipedia.org/wiki/John_Bretland_Farmer}{J.B. Farmer} and \href{https://en.wikipedia.org/wiki/John_Edmund_Sharrock_Moore}{J.E.S. Moore} in 1905:
...
\caption{\href{https://commons.wikimedia.org/wiki/File:Meiosis_Stages.svg}{Diagram of the meiotic phases}}\label{fig:meiosisstages}
\end{figure}
...
\subsection{Prophase I}\label{prophase-i}}
...
\subsection{Metaphase I}\label{metaphase-i}}
...
\subsection{Anaphase I}\label{anaphase-i}}
...
\subsection{Telophase I}\label{telophase-i}}
...
\section{Chromosomal Disorders}\label{chromosomal-disorders}}
...
\subsection{Aberrations}\label{aberrations}}
...
\subsection{Numerical abnormalities}\label{numerical-abnormalities}}
...
\centering        \begin{tabular}[t]{>{\raggedright\arraybackslash}p{5em}>{\raggedright\arraybackslash}p{10em}>{\raggedright\arraybackslash}p{50em}}
\toprule
...
\subsection{Structural abnormalities}\label{structural-abnormalities}}
...
\subsection{Acquired Chromosomal Abnormalities}\label{acquired-chromosomal-abnormalities}}
