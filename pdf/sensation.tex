...
{\centering \includegraphics[width=0.7\linewidth]{./figures/sensation/Human_visual_pathway} 

}
\caption{\href{https://commons.m.wikimedia.org/wiki/File:human_visual_pathway.svg}{A simplified schema} of the human visual pathway.}
\end{figure}
...
{\centering \includegraphics[width=0.7\linewidth]{./figures/sensation/Visual_field_maps} 
