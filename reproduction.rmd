...
```{r spermfertilizingegg, fig.cap='(ref:spermegg)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/reproduction/Sperm-egg.jpg")
```
...
```{r meiosisoverview, fig.cap='(ref:meio)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/reproduction/Meiosis_Overview_new.svg")
```
...
```{r meiosisstages, fig.cap='(ref:meiostages)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/reproduction/Meiosis_Stages.svg")
```
