...
knitr::kable(cellcyc, col.names = c("State", "Phase", "Abbreviation", "Description"), digits = 2, align = 'llll', booktabs = TRUE) %>% collapse_rows(columns = 1, valign = "middle") %>% scroll_box(width = "100%", height = "100") 
```
