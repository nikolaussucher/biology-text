...
```{r celldivision, fig.cap='(ref:celldiv)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/cellcycle/Three_cell_growth_types.svg")
```
...
```{r cellcycle, out.width='75%', echo=FALSE, message=FALSE, warning=FALSE}
library(tidyverse)
library(printr)        
library(kableExtra)
setwd("~/Dropbox/R/biology-text-master")

cellcyc <-  as_tibble(read.csv("data/cell_cycle.csv"))

knitr::kable(cellcyc, col.names = c("State", "Phase", "Abbreviation", "Description"), digits = 2, align = 'llll', booktabs = TRUE, caption = "Phases of the eukaryotic cell cycle") %>% collapse_rows(columns = 1, valign = "middle")
```
...
```{r mito, fig.cap='(ref:mitosis)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/cellcycle/Mitosis_Stages.svg")
```
...
knitr::include_graphics("./figures/cellcycle/human_male_karyotype.png")
```
...
```{r humanchromosomes, fig.cap = 'ref:chr', out.width='75%', echo=FALSE, message=FALSE, warning=FALSE}
library(tidyverse)
library(printr)        
library(kableExtra)
setwd("~/Dropbox/R/biology-text-master")

humchrom <-  as_tibble(read.csv("data/human_chromosomes.csv"))

knitr::kable(humchrom, col.names = c("Chromosome", "Total Length", "Coding Genes"), digits = 2, align = 'ccc', booktabs = TRUE, caption = "(ref:chr)") %>% kable_styling(latex_options = c("striped", "hold_position"))
```
...
```{r numplants, out.width='75%', echo=FALSE, message=FALSE, warning=FALSE}
library(tidyverse)
library(printr)        
library(kableExtra)
setwd("~/Dropbox/R/biology-text-master")

plantchrom <-  as_tibble(read.csv("data/plant_chromosomes.csv"))

knitr::kable(plantchrom, col.names = c("Plant", "Number of Chromosomes"), digits = 2, align = 'lr', booktabs = TRUE, caption = "(ref:numplants)" ) %>% kable_styling(latex_options = c("striped", "hold_position"))
```

(ref:numanimals) Chromosome numbers (2n) in some animals.

```{r numanimals, out.width='75%', echo=FALSE, message=FALSE, warning=FALSE}
library(tidyverse)
library(printr)        
library(kableExtra)
setwd("~/Dropbox/R/biology-text-master")

animalchrom <-  as_tibble(read.csv("data/animal_chromosomes.csv"))

knitr::kable(animalchrom, col.names = c("Animal", "Number of Chromosomes"), digits = 2, align = 'lr', booktabs = TRUE, caption = "(ref:numanimals)") %>% kable_styling(latex_options = c("striped", "hold_position"))
```
...
```{r cellcyclefigure,   fig.cap='(ref:cycle)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/reproduction/Animal_cell_cycle-en.svg")
```
...
```{r onionroot, fig.cap='(ref:onion)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/reproduction/Wilson1900Fig2.jpg")
```
...
```{r prophase, fig.cap='(ref:pro)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/reproduction/ProphaseIF.jpg")
```
...
```{r prometaphase, fig.cap='(ref:prometa)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/reproduction/Prometaphase.jpg")
```
...
```{r metaphase, fig.cap='(ref:meta)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/reproduction/MetaphaseIF.jpg")
```
...
```{r anaphase, fig.cap='(ref:ana)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/reproduction/Anaphase_IF.jpg")
```
...
```{r telophase, fig.cap='(ref:telo)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/reproduction/TelophaseIF.jpg")
```
