...
knitr::kable(plantchrom, col.names = c("Animal", "Number of Chromosomes"), digits = 2, align = 'lr', booktabs = TRUE, caption = "(ref:numanimals)") %>% kable_styling(latex_options = c("striped", "hold_position"))
```
