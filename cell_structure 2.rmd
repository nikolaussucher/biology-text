...
knitr::include_graphics("./figures/cells/Micrographia_title_page.gif")
```
...
knitr::include_graphics("./figures/cells/Hooke-microscope.png")
```
...
knitr::include_graphics("./figures/cells/RobertHookeMicrographia1665.jpg")
```
...
knitr::include_graphics("./figures/cells/Prokaryote_cell.svg")
```
...
```{r typicalanimalcell, fig.cap='(ref:animalcell)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/cells/Animal_cell_structure_en.svg")
```
...
```{r typicalplantcell, fig.cap='(ref:plantcell)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/cells/Plant_cell_structure-en.svg")
```
...
```{r cellcomparison, out.width='75%', echo=FALSE, message=FALSE, warning=FALSE}
library(tidyverse)
library(printr)        
library(kableExtra)
setwd("~/Dropbox/R/biology-text-master")

cellcomp <-  as_tibble(read.csv("data/cell_comparison.csv"))

knitr::kable(cellcomp, col.names = c("", "Prokaryotes", "Eukaryotes"), digits = 2, align = 'lll', booktabs = TRUE, caption = "Comparison of the main features of prokaryotes and eukaryotes.") %>% kable_styling(latex_options = c("striped", "hold_position"))
```
...
```{r cellmembrane, fig.cap='(ref:membrane)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/cells/Cell_membrane_detailed_diagram_en.svg")
```
...
```{r cytoskeleton, fig.cap='(ref:cytoskel)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/cells/FluorescentCells.jpg")
```
...
```{r microfilament, fig.cap='(ref:microfil)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/cells/Microfilament_Structure.svg")
```
...
```{r intermedfilament, fig.cap='(ref:intermedfil)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/cells/Intermediate_filaments.svg")
```
...
```{r microtubulestruc, fig.cap='(ref:microtubule)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/cells/Microtubule_Structure.svg")
```
...
```{r helacellsstained, fig.cap='(ref:helanuc)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/cells/HeLa_cells_stained_with_Hoechst_33258.jpg")
```
...
```{r leeuvenhookcells, fig.cap='(ref:leeuven)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/cells/Leeuwenhoek1719RedBloodCells.jpg")
```
...
```{r electronmicronucleus, fig.cap='(ref:electronnuc)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/cells/Micrograph_of_a_cell_nucleus.png")
```
...
```{r cellnucleus, fig.cap='(ref:cellnuc)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/cells/Diagram_human_cell_nucleus.svg")
```
...
```{r nuclearpore, fig.cap='(ref:nucpore)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/cells/NuclearPore_crop.svg")
```
...
```{r electromitochondrion, fig.cap='(ref:electromito)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/cells/Mitochondria_mammalian_lung_TEM.jpg")
```
...
```{r mitocartoon, fig.cap='(ref:mitocart)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/cells/Mitochondrion_mini.svg")
```
...
```{r dapimitotracker, fig.cap='(ref:fluocell)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/cells/DAPIMitoTrackerRedAlexaFluor488BPAE.jpg")
```
...
```{r chloroplastcartoon, fig.cap='(ref:chlorocart)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/cells/Chloroplast_mini.svg")
```
...
```{r endomembranediagram, fig.cap='(ref:endomembrane)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/cells/Endomembrane_system_diagram_en.svg")
```
...
```{r ribosomestructure, fig.cap='(ref:ribo)', echo=FALSE, message=FALSE, warning=FALSE}
