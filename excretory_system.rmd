...
```{r freshwaterfish, fig.cap='(ref:freshwfish)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/excretory/Bachforelle_osmoregulatoin_bw_en2.png")
```
...
```{r saltwaterfish, fig.cap='(ref:saltwfish)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/excretory/Osmoseragulation_Carangoides_bartholomaei_bw_en2.png")
```
...
```{r urinarysystem, fig.cap='(ref:urinsys)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/excretory/Urinary_system.svg")
```
...
```{r kidney, fig.cap='(ref:kid)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/excretory/Blausen_0592_KidneyAnatomy_01.png")
```
...
```{r kidneystructure, fig.cap='(ref:kidneystruc)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/excretory/KidneyStructures_PioM.svg")
```
...
```{r nephron, fig.cap='(ref:neph)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/excretory/Kidney_Nephron.png")
```
...
```{r urinecreation, fig.cap='(ref:nephphys)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/excretory/Physiology_of_Nephron.svg")
```
...
```{r secretionreabsorption, fig.cap='(ref:secreabs)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/excretory/2618_Nephron_Secretion_Reabsorption.jpg")
```
