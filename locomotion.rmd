...
```{r skullskeletons, fig.cap='(ref:vertebrateskeletons)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/locomotion/Skeletons.png")
```
...
```{r humanskull, fig.cap='(ref:skull)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/locomotion/Human_skull_side_simplified_(bones).svg")
```
...
```{r humanskeletonfront, fig.cap='(ref:humanskeletonfront)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/locomotion/Human_skeleton_front_en.svg")
```
...
```{r humanskeletonback, fig.cap='(ref:humskelba)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/locomotion/Human_skeleton_back_en.svg")
```
...
```{r axialskeleton, fig.cap='(ref:axialsk)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/locomotion/Axial_skeleton_diagram.svg")
```
...
```{r appendicularskeleton, fig.cap='(ref:appendsk)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/locomotion/Appendicular_skeleton_diagram.svg")
```
...
```{r longbone, fig.cap='(ref:longbo)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/locomotion/603_Anatomy_of_Long_Bone.jpg")
```

(ref:bonecross) [Cross-section of human bone.](https://commons.wikimedia.org/wiki/File:Human_skeleton_back_en.svg) 

```{r bonecrossection, fig.cap='(ref:bonecross)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/locomotion/Bone_cross-section.svg")
```
...
```{r anotherbonecrossection, fig.cap='(ref:anotherbonecross)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/locomotion/Illu_compact_spongy_bone.jpg")
```
...
```{r bonecells, fig.cap='(ref:bocel)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/locomotion/604_Bone_cells.jpg")
```
...
```{r threetypesofmuscle, fig.cap='(ref:threetypes)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/locomotion/414_Skeletal_Smooth_Cardiac.jpg")
```
...
```{r skeletalmuscle, fig.cap='(ref:skelmus)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/locomotion/1007_Muscle_Fibes_(large).jpg")
```
...
```{r musclefibre, fig.cap='(ref:muscfib)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/locomotion/1022_Muscle_Fibers_(small).jpg")
```
...
```{r muscularsystem, fig.cap='(ref:muscsys)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/locomotion/1105_Anterior_and_Posterior_Views_of_Muscles.jpg")
```
...
```{r neuromuscularjunction, fig.cap='(ref:neuromusc)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/locomotion/1009_Motor_End_Plate_and_Innervation.jpg")
```
...
```{r crossbridge, fig.cap='(ref:crossbri)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/locomotion/1008_Skeletal_Muscle_Contraction.jpg")
```
...
```{r synovialjoint, fig.cap='(ref:synjoint)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/locomotion/Joint.svg")
```
...
```{r kneeligaments, fig.cap='(ref:kneelig)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/locomotion/Knee_diagram.svg")
```
