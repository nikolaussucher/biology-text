...
knitr::kable(cellcomp, col.names = c("", "Prokaryotes", "Eukaryotes"), digits = 2, align = 'lll', booktabs = TRUE) %>% kable_styling(latex_options = c("striped", "hold_position")) %>% scroll_box(width = "100%", height = "100") 
```
...
## Cdellular Growth And Metabolism
